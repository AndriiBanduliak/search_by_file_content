...
DIRECTORY = r'*****'  #the path where the files are located
FIND_STRING = '****' #what word are you going to look for in the files
...
def print_find_info(file, content, find_string):
    ...
    content = content.replace(find_string,
                              "\x1b[32;1m" + find_string + "\x1b[0m")
    print(f"{file}:\n{content}")
